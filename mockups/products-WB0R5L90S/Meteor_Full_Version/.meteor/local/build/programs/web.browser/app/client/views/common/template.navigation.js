...
Template["navigation"] = new Template("Template.navigation", (function() {
  ...
  return HTML.NAV({
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "dashboard1|dashboard2|dashboard3|dashboard4l"
      }));
    }
  ...
  }, HTML.Raw('<i class="fa fa-pie-chart"></i>'), " ", HTML.Raw('<span class="nav-label">Metrics</span>'), " ", HTML.Raw('<span class="label label-primary pull-right">NEW</span>')), "\n                "), "\n                ", HTML.LI({
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "widgets"
      }));
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "contacts|profile|projects|projectDetail|teamsBoard|clients|fullHeight|fileManager|calendar|issueTracker|blog|article|faq|timelineOne|pinBoard|socialFeed"
      }));
    }
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "toastrNotification|nestableList|agileBoard|timelineTwo|diff|idleTimer|spinners|liveFavicon|googleMaps|codeEditor|modalWindow|forumView|validation|treeView|chatView|sweetAlert"
      }));
    }
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "productsGrid|productsList|productEdit|orders"
      }));
    }
